...
defaults write NSGlobalDomain com.apple.springing.delay -float 0.4
...
rm -rf ~/Library/Containers/com.twitter.twitter-mac/Data/Library/Caches/com.atebits.tweetie.profile-images
