...
_G.packer_plugins = {
  ...
  ["fidget.nvim"] = {
    loaded = true,
    path = "/Users/ssysoev/.local/share/nvim/site/pack/packer/start/fidget.nvim",
  ...
  ["glance.nvim"] = {
    commands = { "Glance" },
    config = { "\27LJ\2\n6\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\27ssysoev.plugins.glance\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "copilot-cmp", "cmp-buffer", "cmp_luasnip" },
  ...
  playground = {
    loaded = true,
    path = "/Users/ssysoev/.local/share/nvim/site/pack/packer/start/playground",
