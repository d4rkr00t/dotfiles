function dthelp() {
    ...
    echo -e ""
    echo -e "${color_func}bootstrap-csscomb${color_reset} — Copy default .csscomb.json to current folder"
    echo -e "${color_func}bootstrap-eslint${color_reset} — Copy default .eslintrc to current folder"
    echo -e "${color_func}bootstrap-editorconfig${color_reset} — Copy default .editorconfig to current folder"
    echo -e ""
